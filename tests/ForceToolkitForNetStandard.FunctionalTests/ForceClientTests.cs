...
namespace Salesforce.Force.FunctionalTests
{
    ...
    public class ForceClientTests
    {
        ...
        public void Init()
        {
            ...
            var config = JsonConvert.DeserializeObject<FunctionalTests.BulkForceClientConfig>(jsonConfig);
        ...
        public async Task Create_Account_Typed()
        {
            ...
            Assert.IsNotNull(successResponse.Id);
            Assert.AreNotEqual(successResponse.Id, string.Empty);
        }
        ...
        public async Task Update_Account_NameChanged()
        {
            ...
            Assert.IsTrue(result.Name == newName);
        }
        ...
        public async Task QueryLeadWithUnescapedCharactersInEmail()
        {
            ...
            Assert.AreNotEqual(result.TotalSize, 0);
        }
